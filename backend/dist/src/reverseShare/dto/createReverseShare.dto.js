...
class CreateReverseShareDTO {
    static _OPENAPI_METADATA_FACTORY() {
        return { sendEmailNotification: { required: true, type: () => Boolean }, maxShareSize: { required: true, type: () => String }, shareExpiration: { required: true, type: () => String }, maxUseCount: { required: true, type: () => Number, minimum: 1, maximum: 1000 }, simplified: { required: true, type: () => Boolean }, publicAccess: { required: true, type: () => Boolean } };
    }
}
...
__decorate([
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], CreateReverseShareDTO.prototype, "simplified", void 0);
__decorate([
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], CreateReverseShareDTO.prototype, "publicAccess", void 0);
