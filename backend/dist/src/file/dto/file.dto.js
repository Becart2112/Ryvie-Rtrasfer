...
class FileDTO {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, name: { required: true, type: () => String }, size: { required: true, type: () => String }, share: { required: true, type: () => require("../../share/dto/share.dto").ShareDTO } };
    }
}
