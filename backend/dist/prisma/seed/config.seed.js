...
async function seedConfigVariables() {
    for (const [category, configVariablesOfCategory] of Object.entries(exports.configVariables)) {
        let order = 0;
        for (const [name, properties] of Object.entries(configVariablesOfCategory)) {
...
async function migrateConfigVariables() {
    ...
    for (const existingConfigVariable of existingConfigVariables) {
        const configVariable = exports.configVariables[existingConfigVariable.category]?.[existingConfigVariable.name];
        if (!configVariable) {
            ...
            const variableOrder = Object.keys(exports.configVariables[existingConfigVariable.category]).indexOf(existingConfigVariable.name);
